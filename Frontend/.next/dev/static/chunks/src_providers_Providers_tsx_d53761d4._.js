...
function Providers(t0) {
    ...
    if ($[0] !== "10513634e6cadae00197786aecb2f612497dd1f44084dc7640e058ed6fc805d3") {
        for(let $i = 0; $i < 5; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "10513634e6cadae00197786aecb2f612497dd1f44084dc7640e058ed6fc805d3";
    }
    const { children } = t0;
    let t1;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t1 = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$query$2d$core$2f$build$2f$modern$2f$queryClient$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["QueryClient"]();
        $[1] = t1;
    } else {
        t1 = $[1];
    }
